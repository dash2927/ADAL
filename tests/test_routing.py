...
# Test for getting the create page
...
def test_create_page_routing(client):
    ...
    responseData = response.data
    assert b'<h1>Redirecting...</h1>' in responseData
    assert b'<p>You should be redirected automatically to target URL: <a href="/login">/login</a>' in responseData
...
# Test for getting the signout page
